      ...
      <div className="relative border-l-2 border-amber-900/30 ml-4 md:ml-8 space-y-12 pb-8">
        {treks.map((trek, idx) => (
          ...
          >
            ...
            <div className="bg-gradient-to-br from-stone-900 to-black border border-white/5 rounded-2xl shadow-xl relative overflow-hidden group hover:border-amber-900/50 transition-colors">
              
              {/* Trek Image */}
              <div className="relative h-44 w-full">
                <img src={trek.image} alt={trek.name} className="absolute inset-0 w-full h-full object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-stone-900 via-stone-900/40 to-transparent" />
                <div className="absolute bottom-3 right-3 bg-amber-900/60 backdrop-blur font-mono text-amber-200 px-3 py-1 rounded-full text-sm border border-amber-700/30">
                  ₹{trek.price}
                </div>
              </div>
              ...
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-chalk text-amber-400 font-bold tracking-widest">{trek.name}</h3>
              </div>
